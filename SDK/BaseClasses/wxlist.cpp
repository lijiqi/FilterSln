...
/* Return a position enumerator for the entire list.
   ...
   may be gone).
*/
__out_opt POSITIONEX CBaseList::GetHeadPositionI() const
{
...
__out_opt POSITIONEX CBaseList::GetTailPositionI() const
{
...
*/
__out void *CBaseList::GetNextI(__inout POSITIONEX& rp) const
{
...
*/
__out_opt void *CBaseList::GetI(__in_opt POSITIONEX p) const
{
    if (p == NULL) {
        return NULL;
    }
...
__out void *CBaseList::GetValidI(__in POSITIONEX p) const
{
    CNode * pn = (CNode *) p;
    void *pObject = pn->GetData();
    // ASSERT(pObject != NULL);    // NULL pointers in the list are allowed.
...
*/
__out_opt POSITIONEX CBaseList::FindI( __in void * pObj) const
{
    POSITIONEX pn;
...
__out_opt void *CBaseList::RemoveHeadI()
{
    ...
    */
    ...
    return RemoveI((POSITIONEX)m_pFirst);
} // RemoveHead
...
__out_opt void *CBaseList::RemoveTailI()
{
    ...
    */
    ...
    return RemoveI((POSITIONEX)m_pLast);
} // RemoveTail
...
*/
__out_opt void *CBaseList::RemoveI(__in_opt POSITIONEX pos)
{
...
__out_opt POSITIONEX CBaseList::AddTailI(__in void *pObject)
{
    /* Lock the critical section before continuing */
...
*/
__out_opt POSITIONEX CBaseList::AddHeadI(__in void *pObject)
{
    CNode *pNode;
    // ASSERT(pObject);  // NULL pointers in the list are allowed.
...
BOOL CBaseList::AddTail(__in CBaseList *pList)
{
    ...
    */
    POSITIONEX pos = pList->GetHeadPositionI();
...
*/
__out_opt POSITIONEX  CBaseList::AddAfterI(__in_opt POSITIONEX pos, __in void * pObj)
{
    if (pos==NULL)
...
BOOL CBaseList::AddAfter(__in_opt POSITIONEX p, __in CBaseList *pList)
{
    POSITIONEX pos;
...
*/
__out_opt POSITIONEX CBaseList::AddBeforeI(__in_opt POSITIONEX pos, __in void * pObj)
{
    if (pos==NULL)
        return AddTailI(pObj);
...
BOOL CBaseList::AddBefore(__in_opt POSITIONEX p, __in CBaseList *pList)
{
    POSITIONEX pos;
    INTERNALREVERSETRAVERSELIST(*pList, pos) {
        /* p follows along the elements being added */
...
BOOL CBaseList::MoveToTail
        (__in_opt POSITIONEX pos, __in CBaseList *pList)
{
    /* Algorithm:
